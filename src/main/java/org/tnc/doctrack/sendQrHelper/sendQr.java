 ...
 * 
 */
package org.tnc.doctrack.sendQrHelper;
...
public class sendQr implements Runnable {
	...
	public static  NodeService nodeService= docTrackBehaviours.serviceRegistry.getNodeService();
	public static  SearchService searchService=docTrackBehaviours.serviceRegistry.getSearchService();
	public static  StoreRef storeRef=new StoreRef(StoreRef.PROTOCOL_WORKSPACE, "SpacesStore");
	public static  ActionService actionService=docTrackBehaviours.serviceRegistry.getActionService();
	public static  NamespaceService nameSpaceService=docTrackBehaviours.serviceRegistry.getNamespaceService();
   ...
   public void sendQrMail() {
			...
			if (this.template.length() == 0) {
			   ...
			   NodeRef person= docTrackBehaviours.serviceRegistry.getPersonService().getPersonOrNull(nodeCeator);
			...
			for (int i = 0; i < qrLabels.length(); i++) {
		          ...
		          list.add(new TemplateNode(node, docTrackBehaviours.serviceRegistry, null));
		        }
